...
// Процедура - Определение вида документа.
//
// Параметры:
...
// Процедура - Получение счета-фактуры, находящегося в подвале документа-основания, чья форма передана в качестве
//             параметра.
//
// Параметры:
...
// Процедура - Свойства справочника контрагенты. Обязательна для заполнения!
...
// Процедура - Получение объекта (ДанныеФормыСтруктура) и ссылки(ДокументСсылка, СправочникСсылка) документа или
